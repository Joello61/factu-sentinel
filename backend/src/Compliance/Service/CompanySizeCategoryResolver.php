 ...
 * versionné dans la RuleVersion "eligibilite-calendrier-taille" — jamais un seuil codé en
    ...
    public function resolve(
        ...
        if (null === $ruleVersion) {
            throw new RegulatoryRuleVersionNotFoundException(
                sprintf('No active RuleVersion for rule "%s" at %s.', RuleId::ELIGIBILITE_CALENDRIER_TAILLE, $at->format('Y-m-d')),
            );
        }
