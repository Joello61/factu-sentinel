 ...
 * (@/components/ui/ComplianceResultBadge) : ce badge ne représente que l'état du cycle de vie
 * d'analyse (docs/08-api-specification.md, section 28), jamais un verdict de conformité.
 */
