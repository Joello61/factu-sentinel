...
**Valeurs retenues (décision produit, section 70)** : `Primary #00695C` (teal/vert-bleu profond), `Success #2E7D32`, `Warning #ED6C02`, `Error #D32F2F`, `Info #0288D1` — à valider en contraste WCAG avant implémentation définitive (section 6). Les valeurs Neutral et les teintes du système de conformité dédié (ci-dessous) restent à définir en implémentation, dans le respect de ces couleurs de base.
...
**Règle centrale, reprise de la mission** : *une erreur doit expliquer ce qui est incorrect et comment le corriger* — appliquée à tous les formulaires du produit, en écho direct au principe d'explicabilité qui gouverne aussi les résultats de conformité (section 29).
...
|---|---|---|
| Palette de couleurs exacte (valeurs précises) | **Primary `#00695C`** (teal/vert-bleu profond), **Success `#2E7D32`**, **Warning `#ED6C02`**, **Error `#D32F2F`**, **Info `#0288D1`** (section 5). La charte de marque complète (logo, univers visuel) reste hors périmètre de ce document. | Résolu — palette fonctionnelle actée ; contraste WCAG à valider avant implémentation définitive |
