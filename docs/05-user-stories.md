...
**US-CUSTOMER-003** _(P2 - proposition à valider)_
...
**US-COMPLIANCE-001** _(cœur du produit)_
...
**US-COMPLIANCE-005** _(point de différenciation majeur identifié en étude de marché)_
...
**US-COMPLIANCE-006bis** _(ajoutée - décision produit)_
Epic : EPIC-COMPLIANCE - Persona : Utilisateur (tous)
...
**US-COMPLIANCE-007** _(P2 - cas limite documenté dans l'étude réglementaire)_
...
**US-COMPLIANCE-008** _(P2 - proposition dérivée du PRD, non explicitement une US du PRD)_
...
**US-NOTIFICATION-001** _(P2 - analysé par le PRD comme raisonnable pour V1, non P0)_
...
**US-NOTIFICATION-002** _(FUTURE)_
Epic : EPIC-NOTIFICATIONS - Persona : Utilisateur (tous)
...
Un état supplémentaire, non un état de _résultat_ mais un état de _traitement_, est nécessaire pour couvrir le cycle de vie complet d'une analyse (implicite dans le parcours du PRD mais non nommé explicitement) :
