...
Request: { "legal_name": "string?", "fiscal_context": { "vat_status": "string?", "company_size_category": "string?" } }
...
Async: Non.
Audit: Oui — AuditLogEntry(event_type="organization_updated"), delta des champs modifiés.
```
