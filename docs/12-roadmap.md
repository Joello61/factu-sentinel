...
| Stratégie de sauvegarde du stockage documentaire local (ADR-007) avant tout volume significatif                                                                                                                                                                                                                                                                                                               | Technique / Sécurité      | Le stockage local est une dette technique intentionnelle nécessitant une vigilance de sauvegarde spécifique (`10-security-privacy.md` section 24, 54) | Moyenne                                                       | Avant Phase 10                                                                       |
